/******************************************************************************************************************************
STORED PROCEDURE: spDebugLogSelectByDateRange
VERSION: 1.0.0
...
IF EXISTS (SELECT name FROM dbo.sysobjects WHERE name = 'spDebugLogSelectByDateRange')
	DROP PROCEDURE spDebugLogSelectByDateRange
GO 

CREATE PROCEDURE [dbo].[spDebugLogSelectByDateRange]
(
    @FromDate          DateTime, 
    @ToDate            DateTime, 
...
EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'1.0.0' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spDebugLogSelectByDateRange'
GO
